                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-2">
                            ...
                            {/* <button onClick={this.props.deleteClick(this.state.currentPostID)} >erase</button> */}
                        </div>
                            ...
                            {this.state.posts.map((v) => {
                                ...
                                if (v.post_id === this.state.currentPostID) {
                                    return <div key={v.post_id}>
                                        ...
                                        <div id="postViewEdit">
                                            <input type="text" data-testid="viewPostBody" className='postViewBody' id="viewPostBody"
